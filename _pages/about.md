...
title: about
permalink: /
subtitle: PhD Student at <a href='https://www.mit.edu/'>MIT</a>

profile:
  align: right
  # --- Profile picture selection ---
  # Uncomment ONE of the following lines to choose your headshot:
  # image: prof_pic_color_1.jpg # Color, close up pose 1 (DSC_2652c)
  image: prof_pic_bw_1.jpg  # Black & white, close-up, pose 1 (DSC_2652bw)
  # image: prof_pic_color_2.jpg # Color, slick, pose 2 (DSC_2683c)
  # image: prof_pic_bw_2.jpg  # Black & white, slick, pose 2 (DSC_2683bw)
  image_circular: false # crops the image to make it circular
  more_info: >
    <p>MIT ORC & MIT LIDS</p>
...
<!-- Add more about your research, background, and interests here -->

You can reach me at [ptsimpos@mit.edu](mailto:ptsimpos@mit.edu).
